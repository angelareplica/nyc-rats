...
d3.csv(require('./data/borough_sightings_count_Nov112019.csv')).then(ready).catch(function (err) {
...
function ready(datapoints) {
  ...
  waffle.selectAll('.block').data(datapoints).enter().append('div').attr('class', 'block')
  ...
  legend.selectAll('.legend-squares').data(boroughs).enter().append('div').attr('class', 'legend-squares').style('background-color', function (d) {
    // console.log(d)
    if (d === 'Brooklyn') {
      return '#657190';
    } else if (d === 'Manhattan') {
...
},{"d3":"../node_modules/d3/index.js","./data/borough_sightings_count_Nov112019.csv":"data/borough_sightings_count_Nov112019.csv"}],"../../../../.npm-global/lib/node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../../../.npm-global/lib/node_modules/parcel/src/builtins/hmr-runtime.js","waffle.js"], null)
//# sourceMappingURL=rats/waffle.67bc3bfb.map